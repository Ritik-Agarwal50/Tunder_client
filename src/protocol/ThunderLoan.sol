...
//e should implemented the thunder loan interface
    ...
    OracleUpgradeable
{
    ...
    function flashloan(
        ...
        //@audit check for reentrancy because state change is hapeening
        assetToken.updateExchangeRate(fee);

        emit FlashLoan(receiverAddress, token, amount, fee, params);
        //@audit again some reentrancy problem here.
    ...
    function updateFlashLoanFee(uint256 newFee) external onlyOwner {
        ...
        //@audit Low:: Emit a event for the new fee
